 ...
 * 
 * @author Prof. Heisler and David Chen
 * @version 2024-9-24
 */
...
public class ShapesDemo {
	...
	public static void demoPartOne() {
		...
		// TODO add one more check of this method
		checkResult("getHeight", "15", "" + r3.getHeight());
		...
		// TODO add one more check of this method
		r3.move(4,  12);
		checkResult("move x", "6", "" + r3.getX());
		checkResult("move y", "20", "" + r3.getY());
		...
		// TODO add one more check of this method
		r3.scale(6,  5);
		checkResult("scale width", "6", "" + r3.getWidth());
		checkResult("scale height", "5", "" + r3.getHeight());
		
		// largerThan
		checkResult("largerThan", "false", "" + r1.largerThan(r2));
		// TODO add one more check of this method
		checkResult("largerThan", "false", "" + r1.largerThan(r3));
		
		// toString
		checkResult("toString", "10 x 20 rectangle at (5, 7)", r2.toString());
		// TODO add one more check of this method
		checkResult("toString", "5 x 15 rectangle at (5, 7)", r3.toString());
		
		// bounding rectangle
		Rectangle boundR1R2 = r1.boundingRectangle(r2);
		checkResult("boundingRectangle", "11 x 20 rectangle at (4, 7)", "" + boundR1R2);
		// TODO add one more check of this method
		Rectangle boundR1R3 = r1.boundingRectangle(r3);
		checkResult("boundingRectangle", "11 x 20 rectangle at (4, 7)", "" + boundR1R3);
	}
